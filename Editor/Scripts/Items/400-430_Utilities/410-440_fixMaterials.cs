...
{
    [MenuItem("kebinImports/Fix All Materials/Poiyomi Toon Shader", false, 410)]
    private static void FAMPTS()
    {
        fixAllMaterials(".poiyomi/• Poiyomi Toon •");
    }
    [MenuItem("kebinImports/Fix All Materials/Poiyomi Toon Shader", true, 410)]
    private static bool ValidateFAMPTS()
    {
        return Directory.Exists(Application.dataPath + @"/_PoiyomiShaders");
    }
    [MenuItem("kebinImports/Fix All Materials/lilToon", false, 420)]
    private static void FAMLT()
    {
        fixAllMaterials("_lil/lilToonMulti");
    }
    [MenuItem("kebinImports/Fix All Materials/lilToon", true, 420)]
    ...
    [MenuItem("kebinImports/Fix All Materials/Standard", false, 440)]
